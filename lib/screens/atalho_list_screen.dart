...
class AtalhoListScreen extends StatelessWidget {
  @override
...
/// Botão Login, para quando o usuária tentar ver a pré lista e não estiver logado
              ...
              return Center(
                child: Container(
                  ...
                  child: Text("Nenhum produto ou serviço na sua lista!",
                    style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),
                    textAlign: TextAlign.center,),
                ),
              );
                  ...
                  ListPrice(() async {
                    ...
                    if(orderId != null)
                      Navigator.of(context).pushReplacement(
                          MaterialPageRoute(builder: (context)=>ListConfirmScreen(orderId))
                      );
                  }),
                ],
              );
