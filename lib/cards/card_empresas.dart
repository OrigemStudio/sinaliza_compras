...
import 'package:sinaliza_compras/screens/company_screen.dart';

class CardEmpresas extends StatefulWidget {
  @override
  _CardEmpresasState createState() => _CardEmpresasState();
}
                    ...
                    child: new Container(
                      ...
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: Image.asset('assets/card_empresas.gif'),
