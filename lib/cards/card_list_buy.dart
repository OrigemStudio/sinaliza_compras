...
class CardListBuy extends StatefulWidget {
  @override
  _CardListBuyState createState() => _CardListBuyState();
}

class _CardListBuyState extends State<CardListBuy> {
  @override
                    ...
                    child: new Container(
                      ...
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: Image.asset('assets/card_list_buy.gif'),
